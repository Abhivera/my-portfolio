        ...
        <div className=" mx-auto pt-16 -pb-10 max-w-7xl">
            ...
            <div className="bg-purple-300 w-36 h-36 rounded-lg p-4 select-none ">
              <div className="bg-purple-400  h-28 w-28 flex-col justify-end mx-auto blur-none z-40 items-center text-center text-xl text-white font-medium rounded-lg p-2">
                <div className="basis-[60%] text-5xl font-black ">
                  <h2 className="text-border mt-1 ">&gt;{diffYears}</h2>
                </div>
          ...
          <div className=" text-[0.92rem] text-base mx-12 font-light dark:text-white text-gray-900">
            <p className="mt-6 mb-12 font-normal">
              As a web developer, I excel in problem-solving,
              critical thinking, and adapting to new technologies. Proficient in
              JavaScript, TypeScript, React, Next.js, MongoDB, Tailwind CSS, and
              Material UI. Dedicated to continuous learning and staying abreast
              of latest web development trends. Goal: Mastery and growth in my
              craft.
            </p>

            <p className="text-gray-400 select-none font-semibold mb-1 dark:text-orange-300 ">
              Contact
            </p>

            <p className="">
              I am readily available for connection on my social media
              platforms. <br />
              You can contact me on the{" "}
              <span className="text-red-700 font-bold">GMail</span>{" "}
              <a
                onClick={() =>
                  navigator.clipboard.writeText("abhijitakadeveloper@gmail.com")
                }
              ...
              or you can Call or DM me on{" "}
              <span className="text-green-500 font-bold">Whatsapp</span>{" "}
              <a
                onClick={() =>
                  navigator.clipboard.writeText("8707795477")
                }
                target="blank"
                rel="noopener noreferrer"
