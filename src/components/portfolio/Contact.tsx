      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <div className="relative max-w-3xl">
            <span className="font-mono text-xs uppercase tracking-widest text-[color:var(--dark-cream)]/80">
              ※ Get in touch
            </span>
            <h2
              className="mt-4 font-display text-5xl sm:text-7xl tracking-tight leading-[1]"
              style={{ color: "var(--goose-down)" }}
            >
              Let's build
              <br />
              something <em className="not-italic" style={{ color: "var(--sunset-orange)" }}>great.</em>
            </h2>
            <p className="mt-8 text-lg sm:text-xl max-w-xl" style={{ color: "var(--dark-cream)" }}>
            ...
            <div className="mt-12 flex flex-wrap gap-4">
              <a
                ...
                className="inline-flex items-center gap-2.5 px-6 py-4 rounded-full bg-[color:var(--chocolate)] text-[color:var(--goose-down)] font-medium hover:bg-[color:var(--cocoa)] transition-colors"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-2.5 px-6 py-4 rounded-full bg-[color:var(--goose-down)] text-[color:var(--chocolate)] font-medium hover:bg-[color:var(--dark-cream)] transition-colors"
              >
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4" aria-hidden>
            ...
            <div className="mt-12 flex flex-wrap gap-3 text-sm" style={{ color: "var(--dark-cream)" }}>
              <a
                href="https://www.linkedin.com/in/abhijit-verma-532996165/"
                target="_blank"
                rel="noreferrer"
                aria-label="LinkedIn"
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[color:var(--dark-cream)]/30 hover:bg-[color:var(--chocolate)]/30 transition-colors"
              >
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4" aria-hidden>
